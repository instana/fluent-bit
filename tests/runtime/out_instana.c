...
/* Test functions */
void flb_test_instana_json_invalid(void);
void flb_test_instana_json_long(void);
void flb_test_instana_json_small(void);

/* Test list */
TEST_LIST = {
    {"json_invalid",    flb_test_instana_json_invalid },
    {"json_long",       flb_test_instana_json_long    },
    {"json_small",      flb_test_instana_json_small   },
    {NULL, NULL}
};
...
void flb_test_instana_json_invalid(void)
{
    ...
    out_ffd = flb_output(ctx, (char *) "instana", NULL);
